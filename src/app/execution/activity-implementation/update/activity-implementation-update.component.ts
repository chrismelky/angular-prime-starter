...
import {
  ...
  ProcurementMethod,
} from '../activity-implementation.model';
...
export class ActivityImplementationUpdateComponent implements OnInit {
  ...
  /**
   * When form is valid Create ActivityImplementation or Update if exist else set form has error and return
   * @returns
   */
  save(): void {
  ...
  protected updateForm(activityImplementation: ActivityImplementation): void {
    this.editForm.patchValue({
      ...
      project_output_implemented:
        activityImplementation.project_output_implemented,
      actual_implementation: activityImplementation.actual_implementation,
      financial_actual_implementation:
        activityImplementation.financial_actual_implementation,
      physical_actual_implementation:
        activityImplementation.physical_actual_implementation,
  ...
  protected createFromForm(): ActivityImplementation {
    return {
      ...
      project_output_implemented: this.editForm.get([
        'project_output_implemented',
      ])!.value,
      actual_implementation: this.editForm.get(['actual_implementation'])!
        .value,
      physical_actual_implementation: this.editForm.get([
        'physical_actual_implementation',
      ])!.value,
      financial_actual_implementation: this.editForm.get([
        'financial_actual_implementation',
      ])!.value,
  ...
  saveImplementation() {
    let data = {
      ...
      project_output_implemented_value:
        this.editForm.value.project_output_implemented,
