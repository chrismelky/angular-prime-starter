...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "project-type",
        loadChildren: () =>
          import("../setup/project-type/project-type.module").then(
            (m) => m.ProjectTypeModule
          ),
      },
      {
        path: "expenditure-category",
        loadChildren: () =>
          import(
            "../setup/expenditure-category/expenditure-category.module"
          ).then((m) => m.ExpenditureCategoryModule),
      },
      {
        path: "project-output",
        loadChildren: () =>
      ...
      },
      {
        ...
        loadChildren: () =>
          import("../setup/procurement-type/procurement-type.module").then(
      ...
      },
      {
        ...
        loadChildren: () =>
          import("../setup/procurement-method/procurement-method.module").then(
