...
createComment(
  ...
  getAssessmentReport(admin_hierarchy_id: number, financial_year_id: number,round_id: number){
    const httpOptions = {
      'responseType'  : 'arraybuffer' as 'json'
    };
    return this.http.get<any>(
      `${this.reportUrl}/${admin_hierarchy_id}/${financial_year_id}/${round_id}`,httpOptions
    );
  }
