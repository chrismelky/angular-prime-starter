...
export class AdminHierarchyLevelComponent implements OnInit {
  ...
  adminhierarchy_levels?: AdminHierarchyLevel[] = [];
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.adminhierarchy_levelService
      .query({
        page: pageToLoad,
   ...
   * @param adminhierarchy_level ; If undefined initize new model to create else edit existing model
   */
  createOrUpdate(adminhierarchy_level?: AdminHierarchyLevel): void {
    const data: AdminHierarchyLevel = adminhierarchy_level ?? {
   ...
   */
  delete(adminhierarchy_level: AdminHierarchyLevel): void {
    this.confirmationService.confirm({
      message: "Are you sure that you want to delete this AdminHierarchyLevel?",
      accept: () => {
        this.adminhierarchy_levelService
          .delete(adminhierarchy_level.id!)
          .subscribe((resp) => {
            this.loadPage(this.page);
  ...
  protected onSuccess(
    ...
    this.adminhierarchy_levels = resp?.data ?? [];
  }
