...
export class CasPlanComponent implements OnInit {
  ...
  /**
   * Creating or updating CasPlan
   * @param casPlan ; If undefined initize new model to create else edit existing model
   */
   ...
   */
  protected onSuccess(
    resp: CustomResponse<CasPlan[]> | null,
    page: number,
    navigate: boolean
  ): void {
