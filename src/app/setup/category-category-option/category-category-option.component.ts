...
@Component({
  selector: "app-category-category-option",
  templateUrl: "./category-category-option.component.html",
})
export class CategoryCategoryOptionComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.categoryCategoryOptionService
      ...
      .subscribe(
        (res: CustomResponse<CategoryCategoryOption[]>) => {
  ...
  /**
   * Creating or updating CategoryCategoryOption
   * @param categoryCategoryOption ; If undefined initize new model to create else edit existing model
   */
  createOrUpdate(categoryCategoryOption?: CategoryCategoryOption): void {
    const data: CategoryCategoryOption = categoryCategoryOption ?? {
      ...new CategoryCategoryOption(),
      category_id: this.category_id,
    };
    const ref = this.dialogService.open(CategoryCategoryOptionUpdateComponent, {
      data,
      header: "Create/Update CategoryCategoryOption",
    });
   ...
   */
  delete(categoryCategoryOption: CategoryCategoryOption): void {
   ...
   */
  protected onSuccess(
    resp: CustomResponse<CategoryCategoryOption[]> | null,
    page: number,
    navigate: boolean
  ): void {
    ...
    this.page = page;
    if (navigate) {
      this.router.navigate(["/category-category-option"], {
        queryParams: {
          page: this.page,
          per_page: this.per_page,
          sort:
  ...
  protected onError(): void {
    ...
    this.page = 1;
    this.toastService.error("Error loading Category Category Option");
  }
}
