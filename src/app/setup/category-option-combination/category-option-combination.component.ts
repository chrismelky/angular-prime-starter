...
@Component({
  selector: 'app-category-option-combination',
  templateUrl: './category-option-combination.component.html',
})
export class CategoryOptionCombinationComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.categoryOptionCombinationService
      ...
      .subscribe(
        (res: CustomResponse<CategoryOptionCombination[]>) => {
  ...
  /**
   * Delete CategoryOptionCombination
   * @param categoryOptionCombination
   */
  delete(categoryOptionCombination: CategoryOptionCombination): void {
    this.confirmationService.confirm({
      message:
        'Are you sure that you want to delete this CategoryOptionCombination?',
      accept: () => {
        this.categoryOptionCombinationService
          .delete(categoryOptionCombination.id!)
          .subscribe((resp) => {
            this.loadPage(this.page);
   ...
   */
  protected onSuccess(
    resp: CustomResponse<CategoryOptionCombination[]> | null,
    page: number,
    navigate: boolean
  ): void {
    ...
    this.page = page;
    if (navigate) {
      this.router.navigate(['/category-option-combination'], {
        queryParams: {
          page: this.page,
          per_page: this.per_page,
          sort:
  ...
  protected onError(): void {
    ...
    this.page = 1;
    this.toastService.error('Error loading Category Option Combination');
  }
}
