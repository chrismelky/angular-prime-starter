...
export class CategoryComponent implements OnInit {
  ...
  /**
   * Creating or updating Category
   * @param category ; If undefined initize new model to create else edit existing model
   */
   ...
   */
  protected onSuccess(
    resp: CustomResponse<Category[]> | null,
    page: number,
    navigate: boolean
  ): void {
  ...
  protected onError(): void {
    ...
    this.page = 1;
    this.toastService.error('Error loading Category');
  }
}
