...
export class UserGroupService {
  ...
  assignMultipleUsers(data: CreateUserGroup): Observable<CustomResponse<null>> {
    return this.http.post<CustomResponse<null>>(`${this.resourceUrl}/assignMultipleUsers`, data);
  }
}
